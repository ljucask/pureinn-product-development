...
> Migration path skill - extracts feature inventory from an existing codebase into Live Register 4
...
- Run KANO Analysis or V×C - not applicable to features already built
