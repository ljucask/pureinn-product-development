...
Show a short state table (N features, has dependency map?, has KANO/V×C?, has roadmap?, current ordering basis if logged). Apply the standard skill interaction pattern (CLAUDE.md).
