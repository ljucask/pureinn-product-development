...
- `feature-forge` - Feature Cards written for features in this Stripe
...
For FS-[ID] [name] - run in order:
  ...
  2. /feature-forge FS-[ID]   → generate Feature Cards
...
| Write Feature Card | FSD done | `/feature-forge` |
...
When a Feature Card is generated by `/feature-forge`, output includes:
