...
The Pureinn product development framework published as a Claude Code plugin. Contains 36 active skills and 2 commands covering the full product lifecycle (v3.x: FDD+SDD hybrid with JIT per-feature design).
